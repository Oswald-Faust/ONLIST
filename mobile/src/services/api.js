...
export const authAPI = {
  ...
  me: () => api.get('/auth/me'),
  googleOAuth: (accessToken, preferredLanguage) => api.post('/auth/google', { accessToken, preferredLanguage }),
  appleOAuth: (identityToken, fullName, email, preferredLanguage) => api.post('/auth/apple', { identityToken, fullName, email, preferredLanguage }),
